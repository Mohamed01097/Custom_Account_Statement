...
class AccountCommonReport(models.TransientModel):
    ...
    with_old_balance = fields.Boolean(string='With Old Balance')
    ...
    def check_report(self):
        ...
        data['form'] = self.read(['date_from','with_old_balance','tag_ids','date_to', 'journal_ids', 'target_move', 'company_id'])[0]
