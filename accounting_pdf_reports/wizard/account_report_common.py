...
class AccountCommonReport(models.TransientModel):
    ...
    with_old_balance = fields.Boolean(string='With Old Balance',default=True)
    with_total = fields.Boolean(string='Total Statement')
    ...
    def check_report(self):
        ...
        data['form'] = self.read(['date_from','with_total','with_old_balance','tag_ids','date_to', 'journal_ids', 'target_move', 'company_id'])[0]
